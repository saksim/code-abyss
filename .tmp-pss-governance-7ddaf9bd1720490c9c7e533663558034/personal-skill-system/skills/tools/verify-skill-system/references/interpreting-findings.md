...
- runtime host-smoke evidence exists but is stale relative to the declared freshness window
- host-smoke scorecard is missing, unreadable, or no longer reflects the current runtime-proof/evidence surface
