...
| `skill-installer` | Codex system | `reject-core` / pack docs | Code Abyss installer and pack docs | Code Abyss owns install, uninstall, pack, and vendor flows; adding a second installer skill would confuse ownership. |
