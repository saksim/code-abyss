...
function analyzeSkillSystem(targetDir) {
  ...
  summary.opportunityRequests = generated.opportunityQueue.entries.length;
  summary.admissionRequests = generated.admissionLedger.entries.length;
  summary.evolutionRequests = generated.evolutionLedger.entries.length;
  summary.investmentBacklogItems = Array.isArray(generated.investmentBacklog.items) ? generated.investmentBacklog.items.length : 0;
  ...
  return {
    ...
    summary: `Audited ${summary.skillFiles} skill files, ${summary.registrySkills} registry entries, ${summary.capabilityModules} capability modules, ${summary.opportunityRequests} future-skill opportunities, ${summary.admissionRequests} admission requests, ${summary.evolutionRequests} evolution requests, ${summary.investmentBacklogItems} investment backlog items, ${summary.routeEntries} route entries, and ${summary.runtimeProofs} runtime proof entries.`,
    findings,
    metrics: summary,
    nextSteps: [
