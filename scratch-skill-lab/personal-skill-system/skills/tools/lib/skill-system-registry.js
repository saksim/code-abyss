...
function validateGeneratedArtifactWriteability(targetDir, findings) {
  const probes = [
    {
      path: path.join(targetDir, 'registry', 'skill-opportunity-queue.generated.json'),
      mode: 'rewrite-file',
      label: 'skill opportunity queue registry'
    },
    {
      path: path.join(targetDir, 'registry', 'review-queue.generated.json'),
      mode: 'rewrite-file',
    ...
    {
      path: path.join(targetDir, 'registry', 'evolution-ledger.generated.json'),
      mode: 'rewrite-file',
    ...
    {
      path: path.join(targetDir, 'registry', 'skill-investment-backlog.generated.json'),
      mode: 'rewrite-file',
